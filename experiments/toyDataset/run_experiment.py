...
import os
# models
import experiments.toyDataset.models as models
import experiments.toyDataset.parser as parser
import experiments.toyDataset.dataset as dataset
import experiments.toyDataset.trainer as trainer
# logger
...
def main(args):
    ...
    dataloaders, test_loader = dataset.get_dataset(batch_size=args.batch_size, num_workers=4, augmentation=args.augment, root="")
