...
import os
# models
import experiments.omniglot.models as models
import experiments.omniglot.parser as parser
import experiments.omniglot.dataset as dataset
import experiments.omniglot.trainer as trainer
# logger
...
def main(args):
    ...
    dataloaders, test_loader = dataset.get_dataset(batch_size=args.batch_size, num_workers=4, augmentation=args.augment)
