...
class Z2CNN(nn.Module):
    def __init__(self, use_bias = False):
        ...
        self.c7 = nn.Conv2d(in_channels=N_channels, out_channels=2        , kernel_size=4          , stride=stride, padding=padding, bias=use_bias)
        # Dropout
...
class P4CNN(nn.Module):
    def __init__(self, use_bias=False, N_channels=10):
        ...
        self.c7 = se2_layers.ConvGG(N_in=N_channels, N_out=2        , kernel_size=4          , h_grid=self.h_grid, input_h_grid=self.h_grid, stride=stride, padding=padding)
        # Dropout
        self.dp = nn.Dropout(p)
        # Batch Normalization
